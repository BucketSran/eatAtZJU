...
import { describeApiSource, getRandomRestaurantRemote, getRestaurantMetadata } from '../services/restaurantService'
...
export function HomePage() {
  ...
  const [dataSource, setDataSource] = useState('等待你开摇')
  ...
  return (
    <div className="route-stack home-route">
      <section className="hero-panel home-hero-panel">
        ...
        <p className="helper-text subtle-helper" aria-live="polite">{dataSource}</p>
      </section>
