...
function normalizeCampus(value?: string | null): CampusOption {
  return campusOptions.includes(value as CampusOption) ? (value as CampusOption) : TUTORIAL_REQUIREMENT_PRESET.campus
}
...
export function HomePage() {
  ...
  const initialMealCategory = TUTORIAL_REQUIREMENT_PRESET.mealCategory
