...
insert into public.restaurants (
  ...
  'r004', '库迪咖啡(浙大紫金港启真湖店)', '库迪咖啡(浙大紫金港启真湖店)', array[]::text[], '校内', 0.37, 5, '茶饮', 9, 4.4, 0, 0, 30.304241, 120.085384, '咖', '#8c6338', array['近', '实惠', '人均30内', '校内', '拍照', '咖啡', '奶茶', '轻负担']::text[], array['赶课快吃', '约会拍照', '懒得出校', '下午茶', '早餐', '中餐']::text[], array['外卖', '堂食']::text[], array['早餐', '中餐', '下午茶', '夜宵']::text[], array['约会拍照', '运动后', '懒得出校']::text[], array['轻负担']::text[], array['拍照', '实惠', '咖啡', '奶茶']::text[], '公开信息整理：高德显示评分 4.4，人均约 ¥9，距离紫金港约 0.4km；当前标签为 近、实惠、人均30内，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0J10CFPJ3","name":"库迪咖啡(浙大紫金港启真湖店)","query":{"type":"amap_around","keyword":"餐饮","page":1},"fetched_at":"2026-05-09T10:27:20.595Z"},{"type":"amap_poi","poi_id":"B0J10CFPJ3","name":"库迪咖啡(浙大紫金港启真湖店)","query":{"type":"amap_around","keyword":"咖啡","page":1},"fetched_at":"2026-05-09T10:27:20.599Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r005', '爷爷不泡茶NOYEYENOTEA(浙大紫金港校内店)', '爷爷不泡茶NOYEYENOTEA(浙大紫金港校内店)', array[]::text[], '校内', 0.4, 5, '茶饮', 13, 4.6, 0, 0, 30.304294, 120.085681, '甜', '#d9915d', array['近', '实惠', '人均30内', '校内', '拍照', '奶茶', '一人食']::text[], array['一人食', '赶课快吃', '约会拍照', '懒得出校', '下午茶', '中餐']::text[], array['外卖', '堂食']::text[], array['早餐', '中餐', '下午茶', '夜宵']::text[], array['一人食', '约会拍照', '懒得出校']::text[], array[]::text[], array['拍照', '实惠', '奶茶']::text[], '公开信息整理：高德显示评分 4.6，人均约 ¥13，距离紫金港约 0.4km；当前标签为 近、实惠、人均30内，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0LB99WOD7","name":"爷爷不泡茶NOYEYENOTEA(浙大紫金港校内店)","query":{"type":"amap_around","keyword":"餐饮","page":1},"fetched_at":"2026-05-09T10:27:20.596Z"},{"type":"amap_poi","poi_id":"B0LB99WOD7","name":"爷爷不泡茶NOYEYENOTEA(浙大紫金港校内店)","query":{"type":"amap_around","keyword":"奶茶","page":1},"fetched_at":"2026-05-09T10:27:20.600Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r007', 'luckin coffee 瑞幸咖啡(紫金港校区西区浙江大学店)', 'luckin coffee 瑞幸咖啡(紫金港校区西区浙江大学店)', array[]::text[], '校内', 0.56, 7, '咖啡', 17, 4.5, 0, 0, 30.298056, 120.07996, '咖', '#8c6338', array['近', '实惠', '人均30内', '校内', '拍照', '咖啡', '轻负担', '一人食']::text[], array['一人食', '赶课快吃', '约会拍照', '懒得出校', '下午茶', '早餐']::text[], array['外卖', '堂食']::text[], array['早餐', '中餐', '下午茶']::text[], array['一人食', '约会拍照', '运动后', '懒得出校']::text[], array['轻负担']::text[], array['拍照', '实惠', '咖啡']::text[], '公开信息整理：高德显示评分 4.5，人均约 ¥17，距离紫金港约 0.6km；当前标签为 近、实惠、人均30内，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0H1P4DLL0","name":"luckin coffee 瑞幸咖啡(紫金港校区西区浙江大学店)","query":{"type":"amap_around","keyword":"餐饮","page":1},"fetched_at":"2026-05-09T10:27:20.596Z"},{"type":"amap_poi","poi_id":"B0H1P4DLL0","name":"luckin coffee 瑞幸咖啡(紫金港校区西区浙江大学店)","query":{"type":"amap_around","keyword":"咖啡","page":1},"fetched_at":"2026-05-09T10:27:20.599Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r008', '紫金港餐饮中心-风味餐厅(浙江大学紫金港校区店)', '紫金港餐饮中心-风味餐厅(浙江大学紫金港校区店)', array[]::text[], '校内', 0.66, 9, '校内食堂', 16, 4.6, 0, 0, 30.307975, 120.085261, '面', '#6d8fbd', array['近', '实惠', '人均30内', '校内', '面食', '暖胃', '聚餐', '食堂']::text[], array['聚餐', '赶课快吃', '懒得出校', '中餐', '晚餐', '暖胃']::text[], array['外卖', '堂食']::text[], array['早餐', '中餐', '晚餐', '夜宵']::text[], array['聚餐', '懒得出校']::text[], array[]::text[], array['暖胃', '面食', '实惠', '食堂']::text[], '公开信息整理：高德显示评分 4.6，人均约 ¥16，距离紫金港约 0.7km；当前标签为 近、实惠、人均30内，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0FFGFQZ3V","name":"紫金港餐饮中心-风味餐厅(浙江大学紫金港校区店)","query":{"type":"amap_around","keyword":"餐饮","page":1},"fetched_at":"2026-05-09T10:27:20.596Z"},{"type":"amap_poi","poi_id":"B0FFGFQZ3V","name":"紫金港餐饮中心-风味餐厅(浙江大学紫金港校区店)","query":{"type":"amap_around","keyword":"中餐","page":1},"fetched_at":"2026-05-09T10:27:20.596Z"},{"type":"amap_poi","poi_id":"B0FFGFQZ3V","name":"紫金港餐饮中心-风味餐厅(浙江大学紫金港校区店)","query":{"type":"amap_around","keyword":"食堂","page":1},"fetched_at":"2026-05-09T10:27:20.601Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r010', '麦思威咖啡', '麦思威咖啡', array[]::text[], '校内', 0.72, 10, '咖啡', 14, 4.5, 0, 0, 30.302666, 120.089435, '咖', '#8c6338', array['近', '实惠', '人均30内', '校内', '拍照', '咖啡', '轻负担', '一人食']::text[], array['一人食', '赶课快吃', '约会拍照', '懒得出校', '下午茶', '早餐']::text[], array['外卖', '堂食']::text[], array['早餐', '中餐', '下午茶']::text[], array['一人食', '约会拍照', '运动后', '懒得出校']::text[], array['轻负担']::text[], array['拍照', '实惠', '咖啡']::text[], '公开信息整理：高德显示评分 4.5，人均约 ¥14，距离紫金港约 0.7km；当前标签为 近、实惠、人均30内，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0LGP5JCEV","name":"麦思威咖啡","query":{"type":"amap_around","keyword":"餐饮","page":1},"fetched_at":"2026-05-09T10:27:20.596Z"},{"type":"amap_poi","poi_id":"B0LGP5JCEV","name":"麦思威咖啡","query":{"type":"amap_around","keyword":"咖啡","page":1},"fetched_at":"2026-05-09T10:27:20.599Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r012', '一鸣真鲜奶吧(浙大紫金港经济学院店)', '一鸣真鲜奶吧(浙大紫金港经济学院店)', array[]::text[], '校内', 0.63, 8, '茶饮', 14, 4.3, 0, 0, 30.297791, 120.078919, '甜', '#d9915d', array['近', '实惠', '人均30内', '校内', '拍照', '奶茶', '一人食']::text[], array['一人食', '赶课快吃', '约会拍照', '懒得出校', '下午茶', '中餐']::text[], array['外卖', '堂食']::text[], array['早餐', '中餐', '下午茶', '夜宵']::text[], array['一人食', '约会拍照', '懒得出校']::text[], array[]::text[], array['拍照', '实惠', '奶茶']::text[], '公开信息整理：高德显示评分 4.3，人均约 ¥14，距离紫金港约 0.6km；当前标签为 近、实惠、人均30内，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0L125U1KT","name":"一鸣真鲜奶吧(浙大紫金港经济学院店)","query":{"type":"amap_around","keyword":"餐饮","page":1},"fetched_at":"2026-05-09T10:27:20.596Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r014', '瑞幸咖啡(浙大医学院店)', '瑞幸咖啡(浙大医学院店)', array[]::text[], '紫金港周边', 0.79, 11, '咖啡', 14, 4.5, 0, 0, 30.295967, 120.084462, '咖', '#8c6338', array['近', '实惠', '人均30内', '拍照', '咖啡', '轻负担', '一人食']::text[], array['一人食', '赶课快吃', '约会拍照', '懒得出校', '下午茶', '早餐']::text[], array['外卖', '堂食']::text[], array['早餐', '中餐', '下午茶']::text[], array['一人食', '约会拍照', '运动后', '懒得出校']::text[], array['轻负担']::text[], array['拍照', '实惠', '咖啡']::text[], '公开信息整理：高德显示评分 4.5，人均约 ¥14，距离紫金港约 0.8km；当前标签为 近、实惠、人均30内，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0KKKUOI13","name":"瑞幸咖啡(浙大医学院店)","query":{"type":"amap_around","keyword":"餐饮","page":2},"fetched_at":"2026-05-09T10:27:20.596Z"},{"type":"amap_poi","poi_id":"B0KKKUOI13","name":"瑞幸咖啡(浙大医学院店)","query":{"type":"amap_around","keyword":"咖啡","page":1},"fetched_at":"2026-05-09T10:27:20.599Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r015', 'luckin coffee 瑞幸咖啡(紫金港校区浙江大学店)', 'luckin coffee 瑞幸咖啡(紫金港校区浙江大学店)', array[]::text[], '校内', 0.7, 9, '咖啡', 13, 4.2, 0, 0, 30.308075, 120.085925, '咖', '#8c6338', array['近', '实惠', '人均30内', '校内', '拍照', '咖啡', '轻负担', '一人食']::text[], array['一人食', '赶课快吃', '约会拍照', '懒得出校', '下午茶', '早餐']::text[], array['外卖', '堂食']::text[], array['早餐', '中餐', '下午茶']::text[], array['一人食', '约会拍照', '运动后', '懒得出校']::text[], array['轻负担']::text[], array['拍照', '实惠', '咖啡']::text[], '公开信息整理：高德显示评分 4.2，人均约 ¥13，距离紫金港约 0.7km；当前标签为 近、实惠、人均30内，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0K2HUHPSU","name":"luckin coffee 瑞幸咖啡(紫金港校区浙江大学店)","query":{"type":"amap_around","keyword":"餐饮","page":1},"fetched_at":"2026-05-09T10:27:20.596Z"},{"type":"amap_poi","poi_id":"B0K2HUHPSU","name":"luckin coffee 瑞幸咖啡(紫金港校区浙江大学店)","query":{"type":"amap_around","keyword":"咖啡","page":1},"fetched_at":"2026-05-09T10:27:20.599Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r016', '库迪咖啡(浙大紫金港成均苑店)', '库迪咖啡(浙大紫金港成均苑店)', array[]::text[], '紫金港南门', 0.7, 9, '咖啡', 13, 4.1, 0, 0, 30.297215, 120.078576, '咖', '#8c6338', array['近', '实惠', '人均30内', '拍照', '咖啡', '轻负担', '一人食']::text[], array['一人食', '赶课快吃', '约会拍照', '懒得出校', '下午茶', '早餐']::text[], array['外卖', '堂食']::text[], array['早餐', '中餐', '下午茶']::text[], array['一人食', '约会拍照', '运动后', '懒得出校']::text[], array['轻负担']::text[], array['拍照', '实惠', '咖啡']::text[], '公开信息整理：高德显示评分 4.1，人均约 ¥13，距离紫金港约 0.7km；当前标签为 近、实惠、人均30内，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0K2ZKTZTI","name":"库迪咖啡(浙大紫金港成均苑店)","query":{"type":"amap_around","keyword":"餐饮","page":1},"fetched_at":"2026-05-09T10:27:20.596Z"},{"type":"amap_poi","poi_id":"B0K2ZKTZTI","name":"库迪咖啡(浙大紫金港成均苑店)","query":{"type":"amap_around","keyword":"咖啡","page":1},"fetched_at":"2026-05-09T10:27:20.599Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r017', '吉利烘焙(浙江大学紫金港店)', '吉利烘焙(浙江大学紫金港店)', array[]::text[], '校内', 0.7, 9, '甜品烘焙', 13, 4.1, 0, 0, 30.309001, 120.083047, '甜', '#d9915d', array['近', '实惠', '人均30内', '校内', '拍照', '甜品', '轻负担', '一人食']::text[], array['一人食', '赶课快吃', '约会拍照', '懒得出校', '下午茶', '中餐']::text[], array['外卖', '堂食']::text[], array['早餐', '中餐', '下午茶']::text[], array['一人食', '约会拍照', '运动后', '懒得出校']::text[], array['轻负担']::text[], array['拍照', '实惠', '甜品']::text[], '公开信息整理：高德显示评分 4.1，人均约 ¥13，距离紫金港约 0.7km；当前标签为 近、实惠、人均30内，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B023B189B4","name":"吉利烘焙(浙江大学紫金港店)","query":{"type":"amap_around","keyword":"餐饮","page":1},"fetched_at":"2026-05-09T10:27:20.596Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r019', '一鸣真鲜奶吧(杭州浙大紫金翠柏店)', '一鸣真鲜奶吧(杭州浙大紫金翠柏店)', array[]::text[], '校内', 0.8, 11, '茶饮', 15, 4.3, 0, 0, 30.30906, 120.085999, '甜', '#d9915d', array['近', '实惠', '人均30内', '校内', '拍照', '奶茶', '一人食', '下饭']::text[], array['一人食', '赶课快吃', '约会拍照', '懒得出校', '下午茶', '早餐']::text[], array['外卖', '堂食']::text[], array['早餐', '中餐', '下午茶', '晚餐', '夜宵']::text[], array['一人食', '约会拍照', '懒得出校']::text[], array[]::text[], array['下饭', '拍照', '实惠', '奶茶']::text[], '公开信息整理：高德显示评分 4.3，人均约 ¥15，距离紫金港约 0.8km；当前标签为 近、实惠、人均30内，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0FFKW58RH","name":"一鸣真鲜奶吧(杭州浙大紫金翠柏店)","query":{"type":"amap_around","keyword":"餐饮","page":2},"fetched_at":"2026-05-09T10:27:20.596Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r020', '瑞幸咖啡(浙江大学紫金港校区店)', '瑞幸咖啡(浙江大学紫金港校区店)', array[]::text[], '校内', 1.05, 14, '咖啡', 9, 4.5, 0, 0, 30.297848, 120.091314, '咖', '#8c6338', array['实惠', '人均30内', '校内', '拍照', '咖啡', '甜品', '轻负担', '一人食']::text[], array['一人食', '约会拍照', '懒得出校', '下午茶', '早餐', '中餐']::text[], array['外卖', '堂食']::text[], array['早餐', '中餐', '下午茶']::text[], array['一人食', '约会拍照', '运动后', '懒得出校']::text[], array['轻负担']::text[], array['拍照', '实惠', '咖啡', '甜品']::text[], '公开信息整理：高德显示评分 4.5，人均约 ¥9，距离紫金港约 1.1km；当前标签为 实惠、人均30内、校内，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0LG4C6PT1","name":"瑞幸咖啡(浙江大学紫金港校区店)","query":{"type":"amap_around","keyword":"餐饮","page":4},"fetched_at":"2026-05-09T10:27:20.596Z"},{"type":"amap_poi","poi_id":"B0LG4C6PT1","name":"瑞幸咖啡(浙江大学紫金港校区店)","query":{"type":"amap_around","keyword":"咖啡","page":1},"fetched_at":"2026-05-09T10:27:20.599Z"},{"type":"amap_poi","poi_id":"B0LG4C6PT1","name":"瑞幸咖啡(浙江大学紫金港校区店)","query":{"type":"amap_around","keyword":"甜品","page":1},"fetched_at":"2026-05-09T10:27:20.600Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r021', '瑞幸咖啡(紫金创业园B幢店)', '瑞幸咖啡(紫金创业园B幢店)', array[]::text[], '西湖区', 0.86, 12, '咖啡', 16, 4.4, 0, 0, 30.308421, 120.075783, '咖', '#8c6338', array['近', '实惠', '人均30内', '拍照', '咖啡', '轻负担', '一人食']::text[], array['一人食', '赶课快吃', '约会拍照', '懒得出校', '下午茶', '早餐']::text[], array['外卖', '堂食']::text[], array['早餐', '中餐', '下午茶']::text[], array['一人食', '约会拍照', '运动后', '懒得出校']::text[], array['轻负担']::text[], array['拍照', '实惠', '咖啡']::text[], '公开信息整理：高德显示评分 4.4，人均约 ¥16，距离紫金港约 0.9km；当前标签为 近、实惠、人均30内，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0J0AL7L3X","name":"瑞幸咖啡(紫金创业园B幢店)","query":{"type":"amap_around","keyword":"餐饮","page":2},"fetched_at":"2026-05-09T10:27:20.596Z"},{"type":"amap_poi","poi_id":"B0J0AL7L3X","name":"瑞幸咖啡(紫金创业园B幢店)","query":{"type":"amap_around","keyword":"咖啡","page":1},"fetched_at":"2026-05-09T10:27:20.599Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r023', '蜜雪冰城(望月店)', '蜜雪冰城(望月店)', array[]::text[], '三墩', 1.18, 16, '茶饮', 8, 4.6, 0, 0, 30.309906, 120.091092, '咖', '#8c6338', array['实惠', '人均30内', '拍照', '咖啡', '奶茶', '轻负担', '一人食']::text[], array['一人食', '约会拍照', '下午茶', '早餐', '中餐', '小吃']::text[], array['外卖', '堂食']::text[], array['中餐', '下午茶', '夜宵']::text[], array['一人食', '约会拍照', '运动后']::text[], array['轻负担']::text[], array['小吃', '拍照', '实惠', '咖啡', '奶茶']::text[], '公开信息整理：高德显示评分 4.6，人均约 ¥8，距离紫金港约 1.2km；当前标签为 实惠、人均30内、拍照，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0FFFZY4TW","name":"蜜雪冰城(望月店)","query":{"type":"amap_around","keyword":"餐饮","page":8},"fetched_at":"2026-05-09T10:27:20.596Z"},{"type":"amap_poi","poi_id":"B0FFFZY4TW","name":"蜜雪冰城(望月店)","query":{"type":"amap_around","keyword":"奶茶","page":1},"fetched_at":"2026-05-09T10:27:20.600Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r024', '蜜雪冰城(杭州旗舰店)', '蜜雪冰城(杭州旗舰店)', array[]::text[], '西溪', 1.31, 17, '茶饮', 8, 4.8, 0, 0, 30.292126, 120.076082, '咖', '#8c6338', array['实惠', '人均30内', '拍照', '咖啡', '奶茶', '轻负担', '一人食']::text[], array['一人食', '约会拍照', '下午茶', '早餐', '中餐', '小吃']::text[], array['外卖', '堂食']::text[], array['中餐', '下午茶', '夜宵']::text[], array['一人食', '约会拍照', '运动后']::text[], array['轻负担']::text[], array['小吃', '拍照', '实惠', '咖啡', '奶茶']::text[], '公开信息整理：高德显示评分 4.8，人均约 ¥8，距离紫金港约 1.3km；当前标签为 实惠、人均30内、拍照，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0HR0ZVB08","name":"蜜雪冰城(杭州旗舰店)","query":{"type":"amap_around","keyword":"奶茶","page":1},"fetched_at":"2026-05-09T10:27:20.600Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r027', '厝内小眷村(浙大紫金港店)', '厝内小眷村(浙大紫金港店)', array[]::text[], '校内', 1.09, 15, '茶饮', 16, 4.6, 0, 0, 30.309626, 120.090079, '甜', '#d9915d', array['实惠', '人均30内', '校内', '拍照', '奶茶', '一人食']::text[], array['一人食', '约会拍照', '懒得出校', '下午茶', '中餐', '小吃']::text[], array['外卖', '堂食']::text[], array['早餐', '中餐', '下午茶', '夜宵']::text[], array['一人食', '约会拍照', '懒得出校']::text[], array[]::text[], array['小吃', '拍照', '实惠', '奶茶']::text[], '公开信息整理：高德显示评分 4.6，人均约 ¥16，距离紫金港约 1.1km；当前标签为 实惠、人均30内、校内，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0HDJ7VMDL","name":"厝内小眷村(浙大紫金港店)","query":{"type":"amap_around","keyword":"餐饮","page":5},"fetched_at":"2026-05-09T10:27:20.596Z"},{"type":"amap_poi","poi_id":"B0HDJ7VMDL","name":"厝内小眷村(浙大紫金港店)","query":{"type":"amap_around","keyword":"奶茶","page":1},"fetched_at":"2026-05-09T10:27:20.600Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r028', '蔡家缙云烧饼&粥铺(紫金港店)', '蔡家缙云烧饼&粥铺(紫金港店)', array[]::text[], '紫金港东门', 1.07, 14, '快餐小吃', 12, 4.4, 0, 0, 30.309575, 120.089875, '饭', '#f0aa38', array['实惠', '人均30内', '快餐', '一人食']::text[], array['一人食', '赶课快吃', '早餐', '中餐', '晚餐', '小吃']::text[], array['外卖']::text[], array['中餐', '夜宵']::text[], array['一人食', '赶课快吃']::text[], array[]::text[], array['小吃', '快餐', '实惠']::text[], '公开信息整理：高德显示评分 4.4，人均约 ¥12，距离紫金港约 1.1km；当前标签为 实惠、人均30内、快餐，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0FFJNT7JU","name":"蔡家缙云烧饼&粥铺(紫金港店)","query":{"type":"amap_around","keyword":"餐饮","page":4},"fetched_at":"2026-05-09T10:27:20.596Z"},{"type":"amap_poi","poi_id":"B0FFJNT7JU","name":"蔡家缙云烧饼&粥铺(紫金港店)","query":{"type":"amap_around","keyword":"快餐","page":1},"fetched_at":"2026-05-09T10:27:20.597Z"},{"type":"amap_poi","poi_id":"B0FFJNT7JU","name":"蔡家缙云烧饼&粥铺(紫金港店)","query":{"type":"amap_around","keyword":"小吃","page":1},"fetched_at":"2026-05-09T10:27:20.598Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r030', '临榆炸鸡腿(浙大紫金港店)', '临榆炸鸡腿(浙大紫金港店)', array[]::text[], '紫金港东门', 1, 13, '异国简餐', 14, 4.3, 0, 0, 30.309322, 120.089133, '饭', '#f0aa38', array['实惠', '人均30内', '快餐', '一人食']::text[], array['一人食', '赶课快吃', '中餐', '晚餐', '快餐', '实惠']::text[], array['外卖']::text[], array['中餐']::text[], array['一人食', '赶课快吃']::text[], array[]::text[], array['快餐', '实惠', '异国料理']::text[], '公开信息整理：高德显示评分 4.3，人均约 ¥14，距离紫金港约 1.0km；当前标签为 实惠、人均30内、快餐，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0JDBSJ3JL","name":"临榆炸鸡腿(浙大紫金港店)","query":{"type":"amap_around","keyword":"餐饮","page":3},"fetched_at":"2026-05-09T10:27:20.596Z"},{"type":"amap_poi","poi_id":"B0JDBSJ3JL","name":"临榆炸鸡腿(浙大紫金港店)","query":{"type":"amap_around","keyword":"快餐","page":1},"fetched_at":"2026-05-09T10:27:20.597Z"},{"type":"amap_poi","poi_id":"B0JDBSJ3JL","name":"临榆炸鸡腿(浙大紫金港店)","query":{"type":"amap_around","keyword":"小吃","page":1},"fetched_at":"2026-05-09T10:27:20.598Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r033', '小满面包烘焙社(浙大紫金港店)', '小满面包烘焙社(浙大紫金港店)', array[]::text[], '校内', 0.88, 12, '甜品烘焙', 22, 4.3, 0, 0, 30.310418, 120.084119, '甜', '#d9915d', array['近', '实惠', '人均30内', '校内', '拍照', '甜品', '面食', '暖胃']::text[], array['赶课快吃', '约会拍照', '懒得出校', '下午茶', '早餐', '中餐']::text[], array['外卖', '堂食']::text[], array['早餐', '中餐', '下午茶', '夜宵']::text[], array['约会拍照', '懒得出校']::text[], array[]::text[], array['暖胃', '面食', '拍照', '实惠', '甜品']::text[], '公开信息整理：高德显示评分 4.3，人均约 ¥22，距离紫金港约 0.9km；当前标签为 近、实惠、人均30内，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0JG5C8BQ0","name":"小满面包烘焙社(浙大紫金港店)","query":{"type":"amap_around","keyword":"餐饮","page":3},"fetched_at":"2026-05-09T10:27:20.596Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r036', '杰里烘焙', '杰里烘焙', array[]::text[], '三墩', 0.87, 12, '甜品烘焙', 28, 4.5, 0, 0, 30.310383, 120.084041, '甜', '#d9915d', array['近', '实惠', '人均30内', '拍照', '甜品', '轻负担', '一人食']::text[], array['一人食', '赶课快吃', '约会拍照', '懒得出校', '下午茶', '中餐']::text[], array['外卖', '堂食']::text[], array['早餐', '中餐', '下午茶']::text[], array['一人食', '约会拍照', '运动后', '懒得出校']::text[], array['轻负担']::text[], array['拍照', '实惠', '甜品']::text[], '公开信息整理：高德显示评分 4.5，人均约 ¥28，距离紫金港约 0.9km；当前标签为 近、实惠、人均30内，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0IAJC0IAG","name":"杰里烘焙","query":{"type":"amap_around","keyword":"餐饮","page":3},"fetched_at":"2026-05-09T10:27:20.596Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r037', '研院咖啡(浙江大学紫金港店)', '研院咖啡(浙江大学紫金港店)', array[]::text[], '校内', 0.78, 10, '咖啡', 26, 4.2, 0, 0, 30.295872, 120.080448, '咖', '#8c6338', array['近', '实惠', '人均30内', '校内', '拍照', '咖啡', '轻负担', '一人食']::text[], array['一人食', '赶课快吃', '约会拍照', '懒得出校', '下午茶', '早餐']::text[], array['外卖', '堂食']::text[], array['早餐', '中餐', '下午茶']::text[], array['一人食', '约会拍照', '运动后', '懒得出校']::text[], array['轻负担']::text[], array['拍照', '实惠', '咖啡']::text[], '公开信息整理：高德显示评分 4.2，人均约 ¥26，距离紫金港约 0.8km；当前标签为 近、实惠、人均30内，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0KU6SW9PO","name":"研院咖啡(浙江大学紫金港店)","query":{"type":"amap_around","keyword":"餐饮","page":2},"fetched_at":"2026-05-09T10:27:20.596Z"},{"type":"amap_poi","poi_id":"B0KU6SW9PO","name":"研院咖啡(浙江大学紫金港店)","query":{"type":"amap_around","keyword":"咖啡","page":1},"fetched_at":"2026-05-09T10:27:20.599Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r039', 'CoCo都可(浙港国际店)', 'CoCo都可(浙港国际店)', array[]::text[], '三墩', 1.3, 17, '中餐简餐', 12, 4.5, 0, 0, 30.308875, 120.093525, '饭', '#f0aa38', array['实惠', '人均30内', '快餐', '一人食', '聚餐', '下饭']::text[], array['一人食', '聚餐', '赶课快吃', '中餐', '晚餐', '下饭']::text[], array['外卖', '堂食']::text[], array['中餐', '晚餐']::text[], array['一人食', '聚餐', '赶课快吃']::text[], array[]::text[], array['下饭', '快餐', '实惠']::text[], '公开信息整理：高德显示评分 4.5，人均约 ¥12，距离紫金港约 1.3km；当前标签为 实惠、人均30内、快餐，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0J1K55RQD","name":"CoCo都可(浙港国际店)","query":{"type":"amap_around","keyword":"奶茶","page":1},"fetched_at":"2026-05-09T10:27:20.600Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r044', '肯德基车速取餐点(浙大紫金港店)', '肯德基车速取餐点(浙大紫金港店)', array[]::text[], '紫金港东门', 0.63, 8, '中餐简餐', 32, 4, 0, 0, 30.306512, 120.077095, '饭', '#f0aa38', array['近', '人均50内', '快餐', '一人食', '聚餐', '下饭']::text[], array['一人食', '聚餐', '赶课快吃', '懒得出校', '中餐', '晚餐']::text[], array['外卖', '堂食']::text[], array['早餐', '中餐', '晚餐']::text[], array['一人食', '聚餐', '赶课快吃', '懒得出校']::text[], array[]::text[], array['下饭', '快餐']::text[], '公开信息整理：高德显示评分 4.0，人均约 ¥32，距离紫金港约 0.6km；当前标签为 近、人均50内、快餐，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0J327054S","name":"肯德基车速取餐点(浙大紫金港店)","query":{"type":"amap_around","keyword":"餐饮","page":1},"fetched_at":"2026-05-09T10:27:20.596Z"},{"type":"amap_poi","poi_id":"B0J327054S","name":"肯德基车速取餐点(浙大紫金港店)","query":{"type":"amap_around","keyword":"小吃","page":1},"fetched_at":"2026-05-09T10:27:20.597Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r046', '麦当劳(宝港生活广场店)', '麦当劳(宝港生活广场店)', array[]::text[], '三墩', 1.1, 15, '异国简餐', 26, 4.6, 0, 0, 30.306562, 120.092588, '辣', '#c84b35', array['实惠', '人均30内', '辣', '快餐', '一人食']::text[], array['一人食', '赶课快吃', '中餐', '晚餐', '快餐', '实惠']::text[], array['外卖']::text[], array['中餐', '晚餐']::text[], array['一人食', '赶课快吃']::text[], array['辣']::text[], array['快餐', '实惠', '异国料理']::text[], '公开信息整理：高德显示评分 4.6，人均约 ¥26，距离紫金港约 1.1km；当前标签为 实惠、人均30内、辣，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0GK1GVETF","name":"麦当劳(宝港生活广场店)","query":{"type":"amap_around","keyword":"餐饮","page":5},"fetched_at":"2026-05-09T10:27:20.596Z"},{"type":"amap_poi","poi_id":"B0GK1GVETF","name":"麦当劳(宝港生活广场店)","query":{"type":"amap_around","keyword":"快餐","page":1},"fetched_at":"2026-05-09T10:27:20.597Z"},{"type":"amap_poi","poi_id":"B0GK1GVETF","name":"麦当劳(宝港生活广场店)","query":{"type":"amap_around","keyword":"小吃","page":2},"fetched_at":"2026-05-09T10:27:20.598Z"},{"type":"amap_poi","poi_id":"B0GK1GVETF","name":"麦当劳(宝港生活广场店)","query":{"type":"amap_around","keyword":"食堂","page":2},"fetched_at":"2026-05-09T10:27:20.601Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r047', '煮赣派·老南昌水煮(浙大紫金港店)', '煮赣派·老南昌水煮(浙大紫金港店)', array[]::text[], '紫金港东门', 1.03, 14, '中餐简餐', 20, 4.2, 0, 0, 30.309461, 120.089367, '饭', '#f0aa38', array['实惠', '人均30内', '快餐', '一人食', '聚餐', '下饭']::text[], array['一人食', '聚餐', '赶课快吃', '中餐', '晚餐', '下饭']::text[], array['外卖', '堂食']::text[], array['中餐', '晚餐']::text[], array['一人食', '聚餐', '赶课快吃']::text[], array[]::text[], array['下饭', '快餐', '实惠']::text[], '公开信息整理：高德显示评分 4.2，人均约 ¥20，距离紫金港约 1.0km；当前标签为 实惠、人均30内、快餐，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0L3J5EAFP","name":"煮赣派·老南昌水煮(浙大紫金港店)","query":{"type":"amap_around","keyword":"餐饮","page":3},"fetched_at":"2026-05-09T10:27:20.596Z"},{"type":"amap_poi","poi_id":"B0L3J5EAFP","name":"煮赣派·老南昌水煮(浙大紫金港店)","query":{"type":"amap_around","keyword":"中餐","page":1},"fetched_at":"2026-05-09T10:27:20.596Z"},{"type":"amap_poi","poi_id":"B0L3J5EAFP","name":"煮赣派·老南昌水煮(浙大紫金港店)","query":{"type":"amap_around","keyword":"小吃","page":1},"fetched_at":"2026-05-09T10:27:20.598Z"},{"type":"amap_poi","poi_id":"B0L3J5EAFP","name":"煮赣派·老南昌水煮(浙大紫金港店)","query":{"type":"amap_around","keyword":"食堂","page":2},"fetched_at":"2026-05-09T10:27:20.601Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r048', '皇家烤猪蹄(望月公寓樱花苑店)', '皇家烤猪蹄(望月公寓樱花苑店)', array[]::text[], '三墩', 1.16, 15, '中餐简餐', 20, 4.4, 0, 0, 30.309818, 120.09085, '饭', '#f0aa38', array['实惠', '人均30内', '快餐', '一人食', '聚餐', '下饭']::text[], array['一人食', '聚餐', '赶课快吃', '中餐', '晚餐', '下饭']::text[], array['外卖', '堂食']::text[], array['中餐', '晚餐']::text[], array['一人食', '聚餐', '赶课快吃']::text[], array[]::text[], array['下饭', '快餐', '实惠']::text[], '公开信息整理：高德显示评分 4.4，人均约 ¥20，距离紫金港约 1.2km；当前标签为 实惠、人均30内、快餐，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0FFHDX9CC","name":"皇家烤猪蹄(望月公寓樱花苑店)","query":{"type":"amap_around","keyword":"餐饮","page":7},"fetched_at":"2026-05-09T10:27:20.596Z"},{"type":"amap_poi","poi_id":"B0FFHDX9CC","name":"皇家烤猪蹄(望月公寓樱花苑店)","query":{"type":"amap_around","keyword":"小吃","page":2},"fetched_at":"2026-05-09T10:27:20.598Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r050', '栗栗烘焙·栗酥饼(浙大紫金港店)', '栗栗烘焙·栗酥饼(浙大紫金港店)', array[]::text[], '紫金港东门', 1.16, 15, '甜品烘焙', 11, 4, 0, 0, 30.309712, 120.090911, '甜', '#d9915d', array['实惠', '人均30内', '拍照', '甜品', '轻负担', '一人食']::text[], array['一人食', '约会拍照', '下午茶', '中餐', '拍照', '清爽']::text[], array['外卖', '堂食']::text[], array['中餐', '下午茶']::text[], array['一人食', '约会拍照', '运动后']::text[], array['轻负担']::text[], array['拍照', '清爽', '实惠', '甜品']::text[], '公开信息整理：高德显示评分 4.0，人均约 ¥11，距离紫金港约 1.2km；当前标签为 实惠、人均30内、拍照，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0LKLH90K5","name":"栗栗烘焙·栗酥饼(浙大紫金港店)","query":{"type":"amap_around","keyword":"餐饮","page":7},"fetched_at":"2026-05-09T10:27:20.596Z"},{"type":"amap_poi","poi_id":"B0LKLH90K5","name":"栗栗烘焙·栗酥饼(浙大紫金港店)","query":{"type":"amap_around","keyword":"小吃","page":2},"fetched_at":"2026-05-09T10:27:20.598Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r054', '北京片皮烤鸭(紫金港店)', '北京片皮烤鸭(紫金港店)', array[]::text[], '紫金港东门', 1.78, 24, '烧烤烤肉', 28, 4, 0, 0, 30.318609, 120.084221, '辣', '#c84b35', array['实惠', '人均30内', '辣', '烧烤', '聚餐', '夜宵', '一人食', '下饭']::text[], array['一人食', '聚餐', '夜宵', '中餐', '晚餐', '下饭']::text[], array['外卖', '堂食']::text[], array['中餐', '晚餐', '夜宵']::text[], array['一人食', '聚餐']::text[], array['辣']::text[], array['下饭', '实惠', '烧烤']::text[], '公开信息整理：高德显示评分 4.0，人均约 ¥28，距离紫金港约 1.8km；当前标签为 实惠、人均30内、辣，置信度 1.00。', '[{"type":"amap_poi","poi_id":"B023B17G6U","name":"北京片皮烤鸭(紫金港店)","query":{"type":"web_clue","keyword":"紫金港餐饮中心 风味餐厅 浙江大学","title":"Apple Maps 紫金港餐饮中心风味餐厅页面","url":"https://maps.apple.com/place?auid=1118368631460667&lsp=57879","publishedAt":"2025-01-01"},"fetched_at":"2026-05-09T10:27:20.601Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r055', '华莱士·全鸡汉堡(浙港国际浙港广场店)', '华莱士·全鸡汉堡(浙港国际浙港广场店)', array[]::text[], '三墩', 1.22, 16, '异国简餐', 18, 4.2, 0, 0, 30.308625, 120.092725, '饭', '#f0aa38', array['实惠', '人均30内', '快餐', '一人食']::text[], array['一人食', '赶课快吃', '中餐', '晚餐', '快餐', '实惠']::text[], array['外卖']::text[], array['中餐']::text[], array['一人食', '赶课快吃']::text[], array[]::text[], array['快餐', '实惠', '异国料理']::text[], '公开信息整理：高德显示评分 4.2，人均约 ¥18，距离紫金港约 1.2km；当前标签为 实惠、人均30内、快餐，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0G26HLHWR","name":"华莱士·全鸡汉堡(浙港国际浙港广场店)","query":{"type":"amap_around","keyword":"快餐","page":1},"fetched_at":"2026-05-09T10:27:20.597Z"},{"type":"amap_poi","poi_id":"B0G26HLHWR","name":"华莱士·全鸡汉堡(浙港国际浙港广场店)","query":{"type":"amap_around","keyword":"小吃","page":4},"fetched_at":"2026-05-09T10:27:20.598Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r056', '张亮麻辣烫(紫金港店)', '张亮麻辣烫(紫金港店)', array[]::text[], '紫金港东门', 1.01, 13, '火锅麻辣烫', 30, 4.3, 0, 0, 30.309365, 120.089194, '辣', '#c84b35', array['实惠', '人均30内', '辣', '火锅', '聚餐', '夜宵', '一人食', '下饭']::text[], array['一人食', '聚餐', '夜宵', '中餐', '晚餐', '下饭']::text[], array['外卖', '堂食']::text[], array['中餐', '晚餐', '夜宵']::text[], array['一人食', '聚餐']::text[], array['辣']::text[], array['下饭', '实惠', '火锅']::text[], '公开信息整理：高德显示评分 4.3，人均约 ¥30，距离紫金港约 1.0km；当前标签为 实惠、人均30内、辣，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0FFH7WCEG","name":"张亮麻辣烫(紫金港店)","query":{"type":"amap_around","keyword":"餐饮","page":3},"fetched_at":"2026-05-09T10:27:20.596Z"},{"type":"amap_poi","poi_id":"B0FFH7WCEG","name":"张亮麻辣烫(紫金港店)","query":{"type":"amap_around","keyword":"小吃","page":1},"fetched_at":"2026-05-09T10:27:20.598Z"},{"type":"amap_poi","poi_id":"B0FFH7WCEG","name":"张亮麻辣烫(紫金港店)","query":{"type":"amap_around","keyword":"食堂","page":2},"fetched_at":"2026-05-09T10:27:20.601Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r058', '鲜目录寿司(浙大紫金港店)', '鲜目录寿司(浙大紫金港店)', array[]::text[], '紫金港东门', 1.23, 16, '异国简餐', 23, 4.4, 0, 0, 30.310471, 120.091188, '异', '#4d79b8', array['实惠', '人均30内', '拍照', '快餐', '一人食', '聚餐', '异国料理']::text[], array['一人食', '聚餐', '赶课快吃', '约会拍照', '中餐', '晚餐']::text[], array['外卖', '堂食']::text[], array['中餐', '下午茶', '晚餐']::text[], array['一人食', '聚餐', '赶课快吃', '约会拍照']::text[], array[]::text[], array['拍照', '快餐', '实惠', '异国料理']::text[], '公开信息整理：高德显示评分 4.4，人均约 ¥23，距离紫金港约 1.2km；当前标签为 实惠、人均30内、拍照，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0FFJASE7M","name":"鲜目录寿司(浙大紫金港店)","query":{"type":"amap_around","keyword":"日料","page":1},"fetched_at":"2026-05-09T10:27:20.601Z"},{"type":"amap_poi","poi_id":"B0FFJASE7M","name":"鲜目录寿司(浙大紫金港店)","query":{"type":"amap_around","keyword":"食堂","page":6},"fetched_at":"2026-05-09T10:27:20.601Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r059', '渔百仓象山海鲜面(西溪银泰城)', '渔百仓象山海鲜面(西溪银泰城)', array[]::text[], '紫金港南门', 1.2, 16, '火锅麻辣烫', 25, 4.4, 0, 0, 30.293799, 120.075017, '辣', '#c84b35', array['实惠', '人均30内', '辣', '火锅', '面食', '暖胃', '聚餐', '夜宵']::text[], array['聚餐', '夜宵', '中餐', '晚餐', '暖胃', '面食']::text[], array['外卖', '堂食']::text[], array['早餐', '中餐', '晚餐', '夜宵']::text[], array['聚餐']::text[], array['辣']::text[], array['暖胃', '面食', '实惠', '火锅']::text[], '公开信息整理：高德显示评分 4.4，人均约 ¥25，距离紫金港约 1.2km；当前标签为 实惠、人均30内、辣，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0FFIL8A78","name":"渔百仓象山海鲜面(西溪银泰城)","query":{"type":"amap_around","keyword":"快餐","page":1},"fetched_at":"2026-05-09T10:27:20.597Z"},{"type":"amap_poi","poi_id":"B0FFIL8A78","name":"渔百仓象山海鲜面(西溪银泰城)","query":{"type":"amap_around","keyword":"小吃","page":3},"fetched_at":"2026-05-09T10:27:20.598Z"},{"type":"amap_poi","poi_id":"B0FFIL8A78","name":"渔百仓象山海鲜面(西溪银泰城)","query":{"type":"amap_around","keyword":"面馆","page":1},"fetched_at":"2026-05-09T10:27:20.598Z"},{"type":"amap_poi","poi_id":"B0FFIL8A78","name":"渔百仓象山海鲜面(西溪银泰城)","query":{"type":"amap_around","keyword":"西餐","page":2},"fetched_at":"2026-05-09T10:27:20.600Z"},{"type":"amap_poi","poi_id":"B0FFIL8A78","name":"渔百仓象山海鲜面(西溪银泰城)","query":{"type":"amap_around","keyword":"食堂","page":5},"fetched_at":"2026-05-09T10:27:20.601Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
...
insert into public.restaurants (
  ...
  'r060', '北街烧烤(三墩店)', '北街烧烤(三墩店)', array[]::text[], '三墩', 0.86, 12, '烧烤烤肉', 33, 4.1, 0, 0, 30.310508, 120.082426, '辣', '#c84b35', array['近', '人均50内', '辣', '烧烤', '聚餐', '夜宵', '一人食', '下饭']::text[], array['一人食', '聚餐', '赶课快吃', '懒得出校', '夜宵', '中餐']::text[], array['外卖', '堂食']::text[], array['早餐', '中餐', '晚餐', '夜宵']::text[], array['一人食', '聚餐', '懒得出校']::text[], array['辣']::text[], array['下饭', '烧烤']::text[], '公开信息整理：高德显示评分 4.1，人均约 ¥33，距离紫金港约 0.9km；当前标签为 近、人均50内、辣，置信度 0.95。', '[{"type":"amap_poi","poi_id":"B0FFKDKDK1","name":"北街烧烤(三墩店)","query":{"type":"amap_around","keyword":"餐饮","page":2},"fetched_at":"2026-05-09T10:27:20.596Z"},{"type":"amap_poi","poi_id":"B0FFKDKDK1","name":"北街烧烤(三墩店)","query":{"type":"amap_around","keyword":"烧烤","page":1},"fetched_at":"2026-05-09T10:27:20.599Z"},{"type":"amap_poi","poi_id":"B0FFKDKDK1","name":"北街烧烤(三墩店)","query":{"type":"amap_around","keyword":"食堂","page":1},"fetched_at":"2026-05-09T10:27:20.601Z"}]'::jsonb, 'published'
)
on conflict (id) do update set
  name = excluded.name,
  canonical_name = excluded.canonical_name,
